...
alias eblumberg="emacs ~/Dropbox/ads/clients/blumberg-capital/blumberg-capital-meeting-notes.org &"
...
alias etracking="emacs ~/Dropbox/control/todo/tracking.org &"

# go to a directory
alias gaws="cd ~/Dropbox/ads/clients/7chord/7chord-01/aws"
alias gdots="cd ~/Dropbox/control/dot-files"
